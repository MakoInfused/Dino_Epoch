...
ZEROPAGE_EXTERN(unsigned char, playerMoneyCount);
...
ZEROPAGE_EXTERN(int, tempInt7);
ZEROPAGE_EXTERN(int, tempInt8);
ZEROPAGE_EXTERN(int, tempInt9);
ZEROPAGE_EXTERN(int, tempIntA);
...
extern const unsigned char boss_01[];
