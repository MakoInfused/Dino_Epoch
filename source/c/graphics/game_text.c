...
unsigned char after_game_text_bank_id;
void (*triggered_after_game_text)(void);
...
void trigger_after_game_text(unsigned char bankId, void (*method)(void)) {
    after_game_text_bank_id = bankId;
    triggered_after_game_text = method;
}
