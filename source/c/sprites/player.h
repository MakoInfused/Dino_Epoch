...
#define PLAYER_SPRITE_INDEX 0x18
...
// sword variables
// We have a few free sprite slots before the map sprites start - the weapon (sword) the player will
// take up the first two sprites, the shield will take up the remaining 2 sprites.
#define PLAYER_EQUIP_ABOVE_OAM_LOCATION 0x08
#define PLAYER_EQUIP_OAM_LOCATION 0x28
...
#define PLAYER_SWORD_POSITION_FULLY_EXTENDED 16

// shield variables
// Where  in our list of files can we find the shield graphics?
#define PLAYER_SHIELD_TILE_ID_V1 0xe0
#define PLAYER_SHIELD_TILE_ID_V2 0xe1
#define PLAYER_SHIELD_TILE_ID_V3 0xf0
#define PLAYER_SHIELD_TILE_ID_V4 0xf1
#define PLAYER_SHIELD_TILE_ID_H1 0xe2
#define PLAYER_SHIELD_TILE_ID_H2 0xf2

#define UNDERWORLD_SHIELD_ENTRANCE 8 * 3 + 7
#define UNDERWORLD_SWORD_ENTRANCE 8 * 4 + 1
#define OVERWORLD_SHIELD_ENTRANCE 8
#define OVERWORLD_SWORD_ENTRANCE 5
...
ZEROPAGE_EXTERN(unsigned char, shieldActive);
ZEROPAGE_EXTERN(unsigned char, hasSword);
ZEROPAGE_EXTERN(unsigned char, hasSwordUpgrade);
ZEROPAGE_EXTERN(unsigned char, hasShield);
