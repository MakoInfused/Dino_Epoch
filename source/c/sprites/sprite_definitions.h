...
#define SPRITE_SIZE_8PX_16PX 0x01
#define SPRITE_SIZE_16PX_8PX 0x02
#define SPRITE_SIZE_16PX_16PX 0x03
#define SPRITE_SIZE_32PX_32PX 0x10
...
// This is used for sprites that mimic the players movements, with collisions.
#define SPRITE_MOVEMENT_PLAYER_MIMIC 4
// This is used for sprites that charge in a random direction, with collisions.
#define SPRITE_MOVEMENT_RANDOM_CHARGE 5
// This is used for sprites that chase the player, with collisions.
#define SPRITE_MOVEMENT_RANDOM_CHASE 6
...
#define SPRITE_TYPE_LIFE_UP 0x08
#define SPRITE_TYPE_BOSS 0x09
#define SPRITE_TYPE_WEAPON 0x0A
#define SPRITE_TYPE_SHIELD 0x0B
#define SPRITE_TYPE_EFFECT 0x0C
#define SPRITE_TYPE_WARP_DOOR 0x0D
#define SPRITE_TYPE_PALETTE_SWAP 0x0E
...
#define SPRITE_DEFINITION_ITEM_SIZE 8
